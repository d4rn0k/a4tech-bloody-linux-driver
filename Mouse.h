...
static const int BLOODY_A90_PID = 0xf6e3;

static const int COMPATIBLE_PIDS[] = { BLOODY_V5_PID, BLOODY_V7_PID,
		BLOODY_V8_PID, BLOODY_R7_PID, BLOODY_R8_1_PID, BLOODY_R3_PID,
		BLOODY_AL9_PID, BLOODY_R70_PID, BLOODY_A90_PID };
static const size_t COMPATIBLE_PIDS_SIZE = sizeof(COMPATIBLE_PIDS)
		/ sizeof(COMPATIBLE_PIDS[0]);
